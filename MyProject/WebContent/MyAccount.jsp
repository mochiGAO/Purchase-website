...
<p>Your balance:</p><%=session.getAttribute("showPeanuts") %>
</div>
	...
	<table  class = "center"style="width: 50%">
		...
		List<PaymentHistory> history =	us.displayPH((String)session.getAttribute("Susrname"));
		
		for(PaymentHistory x : history){
			%>
