			...
			<form action="/MyProject/login" method="post"
				...
				<div class="w3-section">
					<label><b>Username</b></label> <input
						...
						placeholder="Enter Username" name="JSPusrname" required> <label><b>Password</b></label>
					<input class="w3-input w3-border" type="password"
						placeholder="Enter Password" name="JSPpsw" required>
					<button class="w3-button  w3-green w3-section w3-padding w3-center"
						type="submit" style="width: 15%">Login</button>
				</div>
